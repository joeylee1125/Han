...
def validate(court):
    ...
    for i in range(count):
        #print('%s/%s' % (i, count))
        file_name = '2016\\' + court + '\\' + case_matrix['name'][i] + case_matrix['date'][i] + '.docx'
        #print(file_name)
        ...
        if analyser.bgrt:
            ...
            print(case_matrix['name'][i])
    dump2csv(case_matrix, 'C:\\Users\\lij37\\Code\\Summer\\2016\\' + court + '_valid')
